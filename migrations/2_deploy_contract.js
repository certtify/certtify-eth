...
module.exports = function(deployer, network, accounts) {
    ...
    // 20% bouns, 1 ETH: 24,000 CTF
    const weiCostStage1 = web3.toBigNumber(web3._extend.utils.toWei(1, 'ether')).div(web3.toBigNumber(24000));
    // 10% bouns, 1 ETH: 22,000 CTF
    const weiCostStage2 = web3.toBigNumber(web3._extend.utils.toWei(1, 'ether')).div(web3.toBigNumber(22000));
     // 1 ETH: 20,000 CTF
    const weiCostStage3 = web3.toBigNumber(web3._extend.utils.toWei(1, 'ether')).div(web3.toBigNumber(20000));
    const wallet = '0x0AB00ec2b49EE42b09aee64f64f7E20804DC8960';
    const owner = "0x0AB00ec2b49EE42b09aee64f64f7E20804DC8960";
